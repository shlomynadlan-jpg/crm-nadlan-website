...
export const metadata: Metadata = {
  ...
  description: 'מדריכים מקצועיים לנדל"ן מסחרי: איך בוחרים משרד, חישוב עלות אמיתית, שכירות מול רכישה ועוד — מהניסיון של LS נדל"ן בשטח.',
      ...
      <main id="main">
        ...
        <div className="pt-28 pb-12 px-6"
          ...
          <div className="max-w-6xl mx-auto text-center text-white">
            <p className="text-sm font-medium mb-3" style={{ color: '#C9A84C' }}>הידע שלנו — בשבילכם</p>
            <h1 className="text-4xl md:text-5xl font-extrabold mb-4">מאמרים ומדריכים</h1>
            <p className="text-blue-200 text-lg max-w-2xl mx-auto">
              כל מה שלמדנו בשטח על נדל״ן מסחרי — מוגש בגובה העיניים, בלי אותיות קטנות
            </p>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto px-6 py-14">
            ...
            <article className="grid grid-cols-1 lg:grid-cols-2 bg-white rounded-3xl overflow-hidden shadow-lg border border-slate-100 card-hover">
              ...
              <div className="p-8 lg:p-10 flex flex-col justify-center">
                <p className="text-sm text-slate-400 mb-3">
                  {formatDate(featured.date)} · {featured.readingMinutes} דקות קריאה · {AUTHOR}
                </p>
                ...
                <span className="text-blue-600 font-semibold">לקריאת המאמר ←</span>
              </div>
            </article>
          </Link>
                ...
                <article className="bg-white rounded-3xl overflow-hidden shadow-sm border border-slate-100 card-hover h-full flex flex-col">
                  ...
                  <div className="p-7 flex flex-col flex-1">
                    <p className="text-sm text-slate-400 mb-2">
                      {formatDate(a.date)} · {a.readingMinutes} דקות קריאה
                    </p>
                    ...
                    <span className="text-blue-600 font-semibold text-sm mt-5">לקריאת המאמר ←</span>
                  </div>
                </article>
              </Link>
            ))}
          ...
          <div className="mt-16 rounded-3xl p-10 text-center text-white"
            style={{ background: 'linear-gradient(135deg, #0F172A, #0077B6)' }}>
            <h2 className="text-2xl font-bold mb-3">יש לכם שאלה שלא כתבנו עליה?</h2>
            <p className="text-blue-200 mb-6">ספרו לנו מה מעניין אתכם — ואולי המאמר הבא יהיה בשבילכם</p>
