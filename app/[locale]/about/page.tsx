...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  const descs: Record<string, string> = {
    ...
    ru: 'LS Недвижимость — брокерская компания, специализирующаяся на коммерческой и жилой недвижимости. Узнайте, кто мы и как работаем.',
  }
  return {
...
const CONTENT: Record<string, ContentMap> = {
  ...
  ru: {
    ...
    specItems: [
      ...
      { bold: 'Магазины и торговые площади', text: ' — торговые фасады, торговые центры и розничные площади.' },
      { bold: 'Склады и логистика', text: ' — складские помещения, логистические центры и лёгкая промышленность.' },
      { bold: 'Дата-центры', text: ' — специализированные площади для центров обработки данных и технологической инфраструктуры.' },
      { bold: 'Земельные участки', text: ' — земля под строительство, сельское хозяйство, инвестиции и развитие.' },
      { bold: 'Жилая недвижимость', text: ' — квартиры и пентхаусы на продажу и в аренду.' },
      { bold: 'Продажа бизнеса', text: ' — конфиденциальное сопровождение при продаже действующих предприятий, включая переоформление прав аренды.' },
    ],
    howTitle: 'Как мы работаем',
    howItems: [
      { bold: 'Точная информация', text: ' — каждый объект проверяется перед публикацией: данные о площади, цена и базовый правовой статус.' },
      { bold: 'Доступность', text: ' — быстрый ответ на любой запрос по телефону, WhatsApp или email.' },
      { bold: 'Личное сопровождение', text: ' — просмотры объектов, ведение переговоров и поддержка до подписания.' },
      { bold: 'Прозрачность', text: ' — комиссия и обязательства фиксируются заранее в подписанном договоре, как того требует закон.' },
    ],
    contactTitle: 'Свяжитесь с нами',
    contactPara: 'Ищете объект или хотите выставить свою недвижимость? Рады поговорить:',
    contactPhone: 'Шломи Лимор',
    contactEmail: 'Email',
    contactForm: 'Онлайн-форма обратной связи',
    contactHours: 'Часы работы: Вс–Чт 09:00–18:00, Пт 09:00–13:00.',
  },
  fr: {
